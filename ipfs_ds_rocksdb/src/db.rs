...
use crate::{cidbytes::CidBytes, SizeTargets, StoreStats, Synchronous, SingleThreadDb};
...
struct CloumnNames {
    cid: ColumnFamilyDescriptor,
    block: ColumnFamilyDescriptor
}
